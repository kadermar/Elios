...
export default function Connect() {
  return (
    <div className="bg-[#f4f4f4] content-stretch flex flex-col items-center justify-start relative size-full">
      ...
      <div className="bg-white box-border content-stretch flex flex-col gap-[72px] h-[864px] items-center justify-end overflow-clip pb-[140px] pt-[440px] px-[167px] relative shrink-0 w-full">
