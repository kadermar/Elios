...
import RequestTalentNavigation from "../components/RequestTalentNavigation";
...
export default function RequestTalent() {
  ...
  return (
    <div className="bg-[#f4f4f4] content-stretch flex flex-col items-center justify-start relative size-full" data-name="Elios - Request Talent" data-node-id="102:1304">
      <RequestTalentNavigation />
      <div className="content-stretch flex flex-col h-[1002px] items-center justify-center relative shrink-0 w-full" data-name="Hero" data-node-id="102:1360">
