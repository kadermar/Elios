...
export default function Services() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[90px] items-center justify-center px-0 py-[152px] relative size-full" data-name="Services" data-node-id="65:1164">
      <div className="content-stretch flex flex-col gap-[120px] items-center justify-center max-w-[1638px] relative shrink-0 w-full" data-name="Wrapper" data-node-id="65:1191">
        <div className="content-stretch flex flex-col gap-10 items-start justify-center relative shrink-0 w-full" data-name="Subhead Section" data-node-id="65:1192">
          <div className="box-border content-stretch flex gap-2.5 items-center justify-center px-0 py-[18px] relative rounded-[9px] shrink-0" data-name="Tagline" data-node-id="65:1193">
            ...
            <div className="font-semibold leading-[0] not-italic relative shrink-0 text-[#fa6a20] text-[20px] text-nowrap uppercase" data-node-id="65:1195">
              <p className="leading-[24px] whitespace-pre">services</p>
            </div>
          </div>
          <div className="font-semibold leading-[0] not-italic relative shrink-0 text-[#09141f] text-[64px] text-nowrap tracking-[-3.2px]" data-node-id="65:1196">
            <p className="leading-[0.9] whitespace-pre">Two Offerings, One Mission</p>
          </div>
        </div>
        <div className="content-stretch flex gap-[60px] items-start justify-start relative shrink-0 w-full" data-node-id="65:1197">
          <div className="bg-white box-border content-stretch flex flex-col gap-[46px] h-[1019px] items-center justify-center overflow-clip pb-12 pt-6 px-6 relative rounded-[15px] shrink-0 w-[789px]" data-node-id="65:1198">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full" data-node-id="65:1199">
              <div className="[grid-area:1_/_1] bg-stone-100 h-[409px] ml-0 mt-0 rounded-[4px] w-[741px]" data-node-id="65:1200" />
              <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative" data-name="Mask group" data-node-id="65:1201">
                <div className="[grid-area:1_/_1] relative h-[409px] w-[741px] overflow-hidden rounded-[4px]" data-name="image 56" data-node-id="65:1224">
                  <Image 
                    src={imgImage56}
                    alt="Elios Talent"
                    fill
            ...
            <div className="basis-0 box-border content-stretch flex flex-col grow items-start justify-between min-h-px min-w-px px-5 py-0 relative shrink-0 w-full" data-node-id="65:1225">
              <div className="content-stretch flex flex-col gap-[42px] items-start justify-start relative shrink-0 w-full" data-node-id="65:1226">
                <div className="content-stretch flex gap-2.5 items-center justify-center relative shrink-0 w-full" data-node-id="65:1227">
                  <div className="basis-0 font-semibold grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#09141f] text-[40px] tracking-[-2px]" data-node-id="65:1228">
                ...
                <div className="content-stretch flex flex-col gap-[42px] items-start justify-start relative shrink-0 w-full" data-node-id="65:1254">
                  <div className="font-normal leading-[0] not-italic relative shrink-0 text-[#535960] text-[20px] w-full" data-node-id="65:1255">
                  ...
                  <div className="content-stretch flex flex-col gap-[30px] items-start justify-start relative shrink-0 w-full" data-node-id="65:1256">
                    <div className="content-stretch flex gap-[18px] items-center justify-start relative shrink-0 w-full" data-node-id="65:1257">
                      ...
                      <div className="basis-0 content-stretch flex flex-col gap-[18px] grow items-start justify-center min-h-px min-w-px relative shrink-0" data-node-id="65:1259">
                        <div className="font-semibold leading-[0] not-italic relative shrink-0 text-[20px] text-black tracking-[-0.4px] w-full" data-node-id="65:1260">
                          <p className="leading-[24px]">Dedicated recruiters who know your industry inside and out</p>
                        </div>
                      </div>
                    </div>
                    <div className="content-stretch flex gap-[18px] items-center justify-start relative shrink-0 w-full" data-node-id="65:1261">
                      ...
                      <div className="basis-0 content-stretch flex flex-col gap-[18px] grow items-start justify-center min-h-px min-w-px relative shrink-0" data-node-id="65:1263">
                        <div className="font-semibold leading-[0] not-italic relative shrink-0 text-[20px] text-black tracking-[-0.4px] w-full" data-node-id="65:1264">
                          <p className="leading-[24px]">A curated talent network built from thousands of successful placements</p>
                        </div>
                      </div>
                    </div>
                    <div className="content-stretch flex gap-[18px] items-center justify-start relative shrink-0 w-full" data-node-id="65:1265">
                      ...
                      <div className="basis-0 content-stretch flex flex-col gap-[18px] grow items-start justify-center min-h-px min-w-px relative shrink-0" data-node-id="65:1267">
                        <div className="font-semibold leading-[0] not-italic relative shrink-0 text-[20px] text-black tracking-[-0.4px] w-full" data-node-id="65:1268">
                          <p className="leading-[24px]">Structured process for intake, shortlisting, and interview prep</p>
                        </div>
                      </div>
                    </div>
                    <div className="content-stretch flex gap-[18px] items-center justify-start relative shrink-0 w-full" data-node-id="65:1269">
                      ...
                      <div className="basis-0 content-stretch flex flex-col gap-[18px] grow items-start justify-center min-h-px min-w-px relative shrink-0" data-node-id="65:1271">
                        <div className="font-semibold leading-[0] not-italic relative shrink-0 text-[20px] text-black tracking-[-0.4px] w-full" data-node-id="65:1272">
                          <p className="leading-[24px]">Human judgment supported by data and market insights</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="basis-0 bg-white box-border content-stretch flex flex-col gap-[46px] grow items-center justify-center min-h-px min-w-px overflow-clip pb-12 pt-6 px-6 relative rounded-[15px] self-stretch shrink-0" data-node-id="65:1276">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full" data-node-id="65:1277">
              <div className="[grid-area:1_/_1] bg-stone-100 h-[409px] ml-0 mt-0 rounded-[4px] w-[741px]" data-node-id="65:1278" />
              <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative" data-name="Mask group" data-node-id="65:1279">
                <div className="[grid-area:1_/_1] relative h-[409px] w-[741px] overflow-hidden rounded-[4px]" data-name="image 58" data-node-id="65:1302">
                  <Image 
                    src={imgImage58}
                    alt="Elios Insights"
                    fill
