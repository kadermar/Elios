...
export default function Hero() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Hero" data-node-id="65:806">
      <div className="content-stretch flex gap-[140px] items-center justify-start max-w-[1638px] relative shrink-0 w-full" data-name="Wrapper" data-node-id="65:807">
        <div className="content-stretch flex flex-col gap-[100px] items-start justify-start relative shrink-0 w-[694px]" data-name="Hero Text" data-node-id="65:829">
          <div className="content-stretch flex flex-col gap-10 items-start justify-start relative shrink-0 w-full" data-name="Top" data-node-id="65:830">
            <div className="font-semibold leading-[0] min-w-full not-italic relative shrink-0 text-[#09141f] text-[96px] tracking-[-5.76px]" data-node-id="65:831" style={{ width: "min-content" }}>
              <p className="leading-[96px]">Hire with human expertise, at AI speed</p>
            </div>
            <div className="font-normal leading-[0] min-w-full not-italic relative shrink-0 text-[#09141f] text-[24px]" data-node-id="65:832" style={{ width: "min-content" }}>
            ...
            <div className="content-stretch flex gap-3 items-start justify-start relative shrink-0" data-name="Button Row" data-node-id="65:833">
              <div className="bg-[#fa6a20] box-border content-stretch flex gap-4 h-[60px] items-center justify-center pl-[22px] pr-2 py-3.5 relative rounded-[12px] shrink-0 cursor-pointer hover:bg-[#e85a10] transition-colors" data-name="Primary Button" data-node-id="65:834">
                ...
                <div className="bg-white box-border content-stretch flex gap-2.5 items-center justify-center p-[10px] relative rounded-[7px] shrink-0 size-[46px]" data-node-id="65:837">
                  <div className="relative shrink-0 size-4" data-name="Line Rounded/Arrow rigth" data-node-id="65:838">
          ...
          <div className="content-stretch flex gap-[52px] items-center justify-center opacity-50 relative shrink-0" data-name="Logo Reel" data-node-id="65:843">
            <div className="h-[38px] overflow-clip relative shrink-0 w-[90px]" data-name="Weatherford Logo" data-node-id="65:844">
              <div className="text-gray-600 text-sm font-medium flex items-center justify-center h-full">
                Weatherford
              </div>
            </div>
            <div className="h-3.5 overflow-clip relative shrink-0 w-[90px]" data-name="Samsung Logo" data-node-id="65:878">
            ...
            <div className="h-3.5 relative shrink-0 w-20" data-name="Drata Logo" data-node-id="65:881">
              <Image alt="Drata" src={imgDrataWordmarkDark01} width={80} height={14} className="block max-w-none size-full" />
            </div>
            <div className="h-[30px] relative shrink-0 w-[72px]" data-name="Goldman Sachs Logo" data-node-id="65:887">
              <Image alt="Goldman Sachs" src={imgGoldmanSachsLogo01} width={72} height={30} className="block max-w-none size-full" />
            </div>
            <div className="h-[30px] relative shrink-0 w-[98px]" data-name="Amplify Change Logo" data-node-id="65:889">
              <Image alt="Amplify Change" src={imgAmplifyChangeLogo01} width={98} height={30} className="block max-w-none size-full" />
            </div>
          </div>
        </div>
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Hero Image" data-node-id="65:908">
