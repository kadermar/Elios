    ...
    <div className="w-full py-[152px] relative" data-name="Testimonials">
      ...
      <div className="flex flex-col gap-10 items-center justify-center px-4 lg:px-12 relative w-full mb-[90px]" data-name="Subhead Section">
        <div className="flex gap-2.5 items-center justify-center px-0 py-[18px] relative rounded-[9px]" data-name="Tagline">
          ...
          <div className="font-semibold leading-[0] not-italic relative text-[#fa6a20] text-[20px] text-nowrap tracking-[-0.4px] uppercase">
            <p className="leading-[24px] whitespace-pre">TESTIMONIALS</p>
          </div>
        </div>
        ...
        >
            ...
            <div className="flex" style={{ width: 'max-content' }}>
              ...
              <div className="content-stretch flex gap-5 items-center justify-center relative shrink-0" data-name="Row" data-node-id="65:1461">
                <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1462">
                ...
                <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1473">
                ...
                <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start pb-10 pt-0 px-0 relative shrink-0 w-[632px]" data-name="Highlight" data-node-id="65:1484">
                  <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-full transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1485">
                ...
                <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1509">
                ...
                <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1517">
              ...
              <div className="content-stretch flex gap-5 items-center justify-center relative shrink-0" data-name="Row" data-node-id="65:1525">
                <div className="bg-[#e0f1fe] box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 cursor-pointer" data-name="Card" data-node-id="65:1526">
                ...
                <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1537">
                ...
                <div className="bg-[#fae6a4] box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-yellow-500/20 cursor-pointer" data-name="Card" data-node-id="65:1548">
                ...
                <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card" data-node-id="65:1556">
              ...
              <div className="content-stretch flex flex-col gap-5 items-center justify-center relative shrink-0 mr-5" data-name="Card Quotes Copy 2" style={{ width: 'max-content' }}>
                ...
                <div className="content-stretch flex gap-5 items-center justify-center relative shrink-0" data-name="Row">
                  <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card">
                  ...
                  <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start pb-10 pt-0 px-0 relative shrink-0 w-[632px]" data-name="Highlight">
                    <div className="bg-white box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-full transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 cursor-pointer" data-name="Card">
                      <div aria-hidden="true" className="absolute border border-[#fa6a20] border-solid inset-0 pointer-events-none rounded-[15px] shadow-[0px_130px_36px_0px_rgba(254,164,62,0),0px_83px_33px_0px_rgba(254,164,62,0.02),0px_47px_28px_0px_rgba(254,164,62,0.06),0px_21px_21px_0px_rgba(254,164,62,0.1),0px_5px_11px_0px_rgba(254,164,62,0.12)]" />
                      <div className="content-stretch flex flex-col gap-2.5 h-[50px] items-start justify-center relative shrink-0 w-full" data-name="Top">
                ...
                <div className="content-stretch flex gap-5 items-center justify-center relative shrink-0" data-name="Row">
                  <div className="bg-[#e0f1fe] box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 cursor-pointer" data-name="Card">
                    <div className="content-stretch flex flex-col gap-2.5 h-[50px] items-start justify-center relative shrink-0 w-full" data-name="Top">
                      <div className="h-[21px] relative shrink-0 w-[120px]">
                        <Image alt="Drata" src={imgDrataWordmarkDark01} width={120} height={21} className="block max-w-none size-full" />
                      </div>
                  ...
                  <div className="bg-[#fae6a4] box-border content-stretch flex flex-col h-[300px] items-start justify-between px-[30px] py-9 relative rounded-[15px] shrink-0 w-[632px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-yellow-500/20 cursor-pointer" data-name="Card">
                    <div className="content-stretch flex flex-col gap-2.5 h-[50px] items-start justify-center relative shrink-0 w-full" data-name="Top">
                      <div className="h-[22px] overflow-clip relative shrink-0 w-[141.429px]">
                        <div className="absolute bottom-[-0.12%] left-0 right-0 top-0">
                          <Image alt="Samsung" src={imgGroup} width={141} height={22} className="block max-w-none size-full" />
