...
export default function BookStrategySession() {
  ...
  return (
    <div className="bg-[#f4f4f4] content-stretch flex flex-col items-center justify-start relative size-full" data-name="Elios - Contact 2.0">
      <Navigation />
      <div className="content-stretch flex flex-col h-[1002px] items-center justify-center mt-[174px] relative shrink-0 w-full" data-name="Hero">
          ...
          <div className="content-stretch flex flex-col gap-[70px] items-start justify-start relative shrink-0 w-[694px]" data-name="Hero Text">
            <div className="content-stretch flex flex-col gap-10 items-start justify-start leading-[0] not-italic relative shrink-0 text-[#09141f] w-full" data-name="Top">
              <div className="font-aptos font-semibold relative shrink-0 text-[96px] tracking-[-5.76px] w-full">
                <p className="leading-[96px]">Book a Talent Strategy Session</p>
              </div>
            ...
            <div className="content-stretch flex flex-col gap-[30px] items-start justify-start relative shrink-0 w-[549px]">
              <div className="content-stretch flex gap-3 items-center justify-center relative shrink-0 w-full">
                <div className="bg-[#fae6a4] box-border content-stretch flex flex-col gap-2.5 items-center justify-center overflow-clip px-1 py-1.5 relative rounded-[100px] shrink-0 size-[26px]" data-name="Frame">
                ...
                <div className="basis-0 font-aptos font-bold grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#535960] text-[0px]">
                  <p className="leading-[24px] text-[18px]">
                    <span className="text-[#09141f]">Turn Static Data into Actionable Insights</span>
                    <span className>
                      <br aria-hidden="true" className />
                    </span>
                    <span className="font-aptos font-normal not-italic text-[#535960]">See how Elios transforms your existing ATS data into real-time recommendations you can actually act on.</span>
                  </p>
                </div>
              </div>
              <div className="content-stretch flex gap-3 items-center justify-center relative shrink-0 w-full">
                ...
                <div className="basis-0 font-aptos font-bold grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#535960] text-[0px]">
                  <p className="leading-[24px] text-[18px]">
                    <span className="text-[#09141f]">Smarter, Data-Driven Hiring Decisions</span>
                    <span className>
                      <br aria-hidden="true" className />
                    </span>
                    <span className="font-aptos font-normal not-italic text-[#535960]">Discover patterns in hiring performance, candidate pipelines, and ROI to optimize your recruiting strategy.</span>
                  </p>
                </div>
              </div>
              <div className="content-stretch flex gap-3 items-center justify-center relative shrink-0 w-full">
                ...
                <div className="basis-0 font-aptos font-bold grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#535960] text-[0px]">
                  <p className="leading-[24px] text-[18px]">
                    <span className="text-[#09141f]">One Streamlined Workflow</span>
                    <span className>
                      <br aria-hidden="true" className />
                    </span>
                    <span className="font-aptos font-normal not-italic text-[#535960]">Experience how Elios centralizes job requests, candidate matching, and reporting into one seamless platform.</span>
                  </p>
                </div>
              </div>
            </div>
